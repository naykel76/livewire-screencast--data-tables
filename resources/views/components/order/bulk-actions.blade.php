<div class="flex gap-2 justify-end">
    <div class="flex gap-2" x-show="$wire.selectedOrderIds.length > 0" x-cloak>
        ...
        <button type="button" class="flex items-center gap-2 rounded-lg border border-blue-600 px-3 py-1.5 bg-blue-500 font-medium text-sm text-white hover:bg-blue-600">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4">
